...
execute if entity @p[tag=!receive_offer_two,tag=received_offer_two,scores={trade=-1}] if entity @s[scores={trade=2}] run item entity @s weapon.offhand copy entity @e[tag=slot_two,tag=send] weapon.mainhand
execute if entity @p[tag=!receive_offer_two,tag=received_offer_two,scores={trade=-1}] if entity @s[scores={trade=2}] run item entity @p[tag=!receive_offer_two,tag=received_offer_two,scores={trade=-1}] weapon.offhand copy entity @e[tag=slot_two,tag=receive] weapon.mainhand
