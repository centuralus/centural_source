...
execute if entity @s[tag=receive_offer_two,tag=!received_offer_two] unless entity @e[tag=receive,tag=slot_two,type=villager] at @s run summon villager ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b,Health:1f,CustomName:'{"text":"Trade in progress"}',HandItems:[{id:"minecraft:iron_sword",Count:1b},{}],HandDropChances:[1.000F,0.000F],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:999999,ShowParticles:0b}],Tags:["keep","receive","slot","slot_two"]}
