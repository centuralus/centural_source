...
execute if entity @p[scores={wild=2..}] as @a[scores={wild=2..}] if entity @s[scores={wild_timer=-2000..0}] run tellraw @s {"text":"Cooldown active ~ Please wait approximately 20 seconds  before use","color":"yellow"}
