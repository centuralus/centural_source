...
execute if entity @p[tag=poll_create] as @a[tag=poll_create] run give @s written_book{display:{Name:'{"text":"Poll Create"}',Lore:['{"text":"Use this book to create a Poll."}']},poll_create:1b,title:"",author:""} 1
