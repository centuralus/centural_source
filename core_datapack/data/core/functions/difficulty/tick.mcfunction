...
execute if entity @p[scores={difficulty=2}] as @a[scores={difficulty=2}] run tellraw @a[difficulty_timer=1] [{"selector":"@s"}," would like to set the difficulty to Peaceful.","\n",{"text":"To change difficulty all players must click here to accept.","clickEvent":{"action":"run_command","value":"/trigger difficulty set 2"}}]
...
execute if entity @p[scores={difficulty=2}] as @a[scores={difficulty=2}] unless entity @p[scores={difficulty=..1}] unless entity @p[scores={difficulty=3..}] run tag @a reset_difficulty
...
execute if entity @p[scores={difficulty=3}] as @a[scores={difficulty=3}] run tellraw @a[difficulty_timer=1] [{"selector":"@s"}," would like to set the difficulty to Easy.","\n",{"text":"To change difficulty all players must click here to accept.","clickEvent":{"action":"run_command","value":"/trigger difficulty set 3"}}]
...
execute if entity @p[scores={difficulty=3}] as @a[scores={difficulty=3}] unless entity @p[scores={difficulty=..2}] unless entity @p[scores={difficulty=4..}] run tag @a reset_difficulty
...
execute if entity @p[scores={difficulty=4}] as @a[scores={difficulty=4}] run tellraw @a[difficulty_timer=1] [{"selector":"@s"}," would like to set the difficulty to Normal.","\n",{"text":"To change difficulty all players must click here to accept.","clickEvent":{"action":"run_command","value":"/trigger difficulty set 4"}}]
...
execute if entity @p[scores={difficulty=4}] as @a[scores={difficulty=4}] unless entity @p[scores={difficulty=..3}] unless entity @p[scores={difficulty=5..}] run tag @a reset_difficulty
...
execute if entity @p[scores={difficulty=5}] as @a[scores={difficulty=5}] run tellraw @a[difficulty_timer=1] [{"selector":"@s"}," would like to set the difficulty to Normal.","\n",{"text":"To change difficulty all players must click here to accept.","clickEvent":{"action":"run_command","value":"/trigger difficulty set 4"}}]
...
execute if entity @p[scores={difficulty=5}] as @a[scores={difficulty=5}] unless entity @p[scores={difficulty=..4}] unless entity @p[scores={difficulty=6..}] run tag @a reset_difficulty
