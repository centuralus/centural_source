...
execute if score @s vect_y matches 1.. run function cw_edit:zprivate/rotated/load_180/move
execute if score @s vect_y matches ..0 run schedule function cw_edit:zprivate/rotated/load_180/end 1t