...
execute if score @s vect_y matches 1.. run function cw_edit:zprivate/save/move
execute if score @s vect_y matches ..0 run schedule function cw_edit:zprivate/save/end 1t