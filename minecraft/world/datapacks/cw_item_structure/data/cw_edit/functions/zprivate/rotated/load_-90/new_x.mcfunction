...
execute if score @s vect_z matches 1.. run function cw_edit:zprivate/rotated/load_-90/move
execute if score @s vect_z matches ..0 run function cw_edit:zprivate/rotated/load_-90/new_z