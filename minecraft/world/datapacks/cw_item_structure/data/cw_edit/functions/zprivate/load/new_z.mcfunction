...
execute if score @s vect_y matches 1.. run function cw_edit:zprivate/load/move
execute if score @s vect_y matches ..0 run schedule function cw_edit:zprivate/load/end 1t