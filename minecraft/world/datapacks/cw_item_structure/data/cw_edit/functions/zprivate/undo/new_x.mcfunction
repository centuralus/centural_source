...
execute if score @s vect_z matches 1.. run function cw_edit:zprivate/undo/move
execute if score @s vect_z matches ..0 run function cw_edit:zprivate/undo/new_z