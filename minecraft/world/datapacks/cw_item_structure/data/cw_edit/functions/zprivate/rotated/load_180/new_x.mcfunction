...
execute if score @s vect_z matches 1.. run function cw_edit:zprivate/rotated/load_180/move
execute if score @s vect_z matches ..0 run function cw_edit:zprivate/rotated/load_180/new_z