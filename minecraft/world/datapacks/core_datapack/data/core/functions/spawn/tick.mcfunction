...
execute if entity @e[tag=spawn,type=armor_stand] as @e[tag=spawn,type=armor_stand] at @a[distance=..16] unless entity @e[tag=guard,distance=0.5,type=slime] run summon slime ~ ~42 ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Team:"player",NoAI:1b,Size:4,Tags:["guard"],ActiveEffects:[{Id:14b,Amplifier:99b,Duration:19999980,ShowParticles:0b}]}
