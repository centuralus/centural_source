...
execute if entity @p[scores={difficulty=2}] as @a[scores={difficulty=2}] unless entity @p[scores={difficulty=..1}] unless entity @p[scores={difficulty=3..}] run tellraw @s {"text":"Difficulty set to peaceful","color":"yellow"}
...
execute if entity @p[scores={difficulty=2}] as @a[scores={difficulty=2}] if entity @s[scores={difficulty_timer=1000..}] run tellraw @s "Canceled change in difficulty"
execute if entity @p[scores={difficulty=2}] as @a[scores={difficulty=2}] if entity @s[scores={difficulty_timer=1000..}] run tag @s add reset_difficulty
...
execute if entity @p[scores={difficulty=3}] as @a[scores={difficulty=3}] unless entity @p[scores={difficulty=..2}] unless entity @p[scores={difficulty=4..}] run tellraw @s {"text":"Difficulty set to easy","color":"yellow"}
...
execute if entity @p[scores={difficulty=3}] as @a[scores={difficulty=3}] if entity @s[scores={difficulty_timer=1000..}] run tellraw @s "Canceled change in difficulty"
execute if entity @p[scores={difficulty=3}] as @a[scores={difficulty=3}] if entity @s[scores={difficulty_timer=1000..}] run tag @s add reset_difficulty
...
execute if entity @p[scores={difficulty=4}] as @a[scores={difficulty=4}] unless entity @p[scores={difficulty=..3}] unless entity @p[scores={difficulty=5..}] run tellraw @s {"text":"Difficulty set to normal","color":"yellow"}
...
execute if entity @p[scores={difficulty=4}] as @a[scores={difficulty=4}] if entity @s[scores={difficulty_timer=1000..}] run tellraw @s "Canceled change in difficulty"
execute if entity @p[scores={difficulty=4}] as @a[scores={difficulty=4}] if entity @s[scores={difficulty_timer=1000..}] run tag @s add reset_difficulty
...
execute if entity @p[scores={difficulty=5}] as @a[scores={difficulty=5}] unless entity @p[scores={difficulty=..4}] unless entity @p[scores={difficulty=6..}] run tellraw @s {"text":"Difficulty set to normal","color":"yellow"}
...
execute if entity @p[scores={difficulty=5}] as @a[scores={difficulty=5}] if entity @s[scores={difficulty_timer=1000..}] run tellraw @s "Canceled change in difficulty"
execute if entity @p[scores={difficulty=5}] as @a[scores={difficulty=5}] if entity @s[scores={difficulty_timer=1000..}] run tag @s add reset_difficulty
