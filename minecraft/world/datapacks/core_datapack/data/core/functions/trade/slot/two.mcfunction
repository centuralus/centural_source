...
execute unless entity @s[tag=send_offer_two] unless entity @e[tag=send,tag=slot_two,type=armor_stand] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Small:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Health:1f,DisabledSlots:4144703,HandItems:[{id:"minecraft:iron_sword",Count:1b},{}],Tags:["keep","send","slot","slot_two"]}
...
execute if entity @s[tag=receive_offer_two,tag=!received_offer_two] unless entity @e[tag=slot_two,type=armor_stand] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Small:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Health:1f,DisabledSlots:4144703,HandItems:[{id:"minecraft:iron_sword",Count:1b},{}],Tags:["keep","receive","slot","slot_two"]}
