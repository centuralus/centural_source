...
execute unless entity @s[tag=send_offer_two] unless entity @e[tag=send,tag=slot_two,type=armor_stand] run summon armor_stand ~ ~ ~ {Small:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Health:1f,DisabledSlots:4144703,HandItems:[{id:"minecraft:iron_sword",Count:1b},{}],Tags:["keep","send","slot","slot_two"]}
...
execute unless entity @s[tag=send_offer_two] run item entity @e[tag=send,tag=slot_two,limit=1] weapon.offhand copy entity @s weapon.offhand
...
execute if entity @s[tag=receive_offer_two,tag=!received_offer_two] unless entity @e[tag=slot_two,type=armor_stand] run summon armor_stand ~ ~ ~ {Small:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Health:1f,DisabledSlots:4144703,HandItems:[{id:"minecraft:iron_sword",Count:1b},{}],Tags:["keep","receive","slot","slot_two"]}
...
execute if entity @p[tag=!receive_offer_two,tag=received_offer_two,scores={trade=-1}] if entity @s[scores={trade=2}] run item entity @s weapon.offhand copy entity @e[tag=slot_two,tag=send,limit=1] weapon.mainhand
execute if entity @p[tag=!receive_offer_two,tag=received_offer_two,scores={trade=-1}] if entity @s[scores={trade=2}] run item entity @p[tag=!receive_offer_two,tag=received_offer_two,scores={trade=-1}] weapon.offhand copy entity @e[tag=slot_two,tag=receive,limit=1] weapon.mainhand

execute if entity @p[tag=!receive_offer_two,tag=received_offer_two,scores={trade=-1}] if entity @s[scores={trade=2}] run tag @s add reset_offer_two
execute if entity @p[tag=!receive_offer_two,tag=received_offer_two,scores={trade=-1}] if entity @s[scores={trade=2}] run tag @p[tag=!receive_offer_two,tag=received_offer_two,scores={trade=-1}] add reset_offer_two
