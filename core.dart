...
execute if entity @s[tag=receive_offer_${index_as_word},tag=!received_offer_${index_as_word}] unless entity @e[tag=receive,tag=slot_${index_as_word},type=villager] at @s anchored eyes positioned ^ ^ ^1 run summon villager ~ ~ ~ {Health:1f,NoGravity:1b,Silent:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b,CustomName:'{"text":"Trade in progress"}',HandItems:[{},{}],HandDropChances:[1.000F,1.000F],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:999999,ShowParticles:0b}],Tags:["keep","receive","slot","slot_${index_as_word}"]}
